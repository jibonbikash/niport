...
<br />
    ...
    <table class="table table-bordered">
        ...
        <td>{{ $Enrollparticipant->batch?  $Enrollparticipant->batch->name: ''}} </td>
            <td>{{ $Enrollparticipant->batch?  $Enrollparticipant->batch->training_center ? $Enrollparticipant->batch->training_center->name: '' : ''}} </td>
                        ...
                        <div class="card-body collapse show" id="collapse9">
                            <div class="nav-tabs-top">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#navs-top-close">Close</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="navs-top-close">
                                        <div class="card-body">
                                            <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <thead>
                                                ...
                                                <tbody>
                                                @foreach($participant->participantCLOSE as $Enrollparticipant)
                                                    <tr>
                                                        <td>{{ $Enrollparticipant->batch?  $Enrollparticipant->batch->name: ''}} </td>
                                                        <td>{{ $Enrollparticipant->batch?  $Enrollparticipant->batch->training_center ? $Enrollparticipant->batch->training_center->name: '' : ''}} </td>
                                                        <td>{{ $Enrollparticipant->course?  $Enrollparticipant->course->name: ''}}</td>
